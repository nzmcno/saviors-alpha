...
export const metadata: Metadata = {
  ...
  description: 'Join Saviors Alpha NFT Discord, a vibrant community collaborating with NFT projects. Get exclusive whitelists, participate in raffles, and leverage our promotion services. Explore upcoming NFT projects on our website!',
  keywords: ['NFT Discord', 'Collaborations', 'Whitelist', 'Raffles', 'Promotion Services', 'Crypto Art Community', 'Upcoming NFT Projects', 'Saviors Alpha'],
  authors: [{ name: '0xncndev' }],
  openGraph: {
    type: 'website',
    locale: 'en_US',    
    description: 'Join Saviors Alpha NFT CommunityDiscord, a vibrant community collaborating with NFT projects. Get exclusive whitelists, participate in raffles, and leverage our promotion services. Explore upcoming NFT projects on our website!',
